...
| **Analysis** | Skills and agents (deep review) | built-in `/security-review`, `/hef.security-scan` command, `forensic-specialist` agent |
| **Validation** | Quality gates (pre-integration) | `quality-guardian` agent, `/hef.quality` command |
